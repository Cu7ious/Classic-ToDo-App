...
const navButton = css`
  background: url(
    data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADAAAAAwAQAAAAB/ecQqAAAAAnRSTlMAAHaTzTgAAAAWSURBVHgBY6AFYP4PBAewUoPbFMoBAE11OPW6yVcZAAAAAElFTkSuQmCC) no-repeat 50%;
...
export default function Header (props: any) {
  ...
  return (
    <header css={[header, headerColors]}>
      <div css={headerLogo}>
        <h1 css={[headerLeft, H1]} title="React.js based Classic Todo App">
          <button css={navButton} onClick={openSidebar} />
          <span css={logoText}>Todo App</span>
          <svg css={logoSVG} width="27px" height="20px" viewBox="0 0 27 20">
      ...
      <div css={headerRight}>
        <a css={githubBadge} target="_blank" rel="noopener noreferrer" href="https://github.com/Cu7ious/">
          <img src={githubIcon} alt="See more on GitHub" />
        </a>
      </div>
    </header>
  );
