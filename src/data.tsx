...
export enum THEME {
  ...
  REACT_LIGHTBLUE = 'REACT_LIGHTBLUE',
...
export const THEME_COLORS = {
  ...
  REACT_LIGHTBLUE: { MAIN_COLOR: '#61dafb', MAIN_COLOR_DARK: '#3cb6d8' },
  ANGULAR_RED: { MAIN_COLOR: '#dd0130', MAIN_COLOR_DARK: '#a50023' },
  NODE_GREEN: { MAIN_COLOR: '#026e00', MAIN_COLOR_DARK: '#012d00'},
  // ACID_TRIP: { MAIN_COLOR: '#0165c7', MAIN_COLOR_DARK: '#0062a5'}
}

interface AppTheme { appTheme: THEME; }
